   ...
   return (
      <div className="w-full min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-50 dark:bg-black transition-colors duration-500">
         ...
         <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
            <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-red-600/10 dark:bg-red-600/20 rounded-full blur-[120px] animate-pulse"></div>
            <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-600/10 dark:bg-blue-600/10 rounded-full blur-[120px] animate-pulse delay-1000"></div>
         </div>
         ...
         <div className="w-full max-w-md bg-white/70 dark:bg-black/40 backdrop-blur-xl rounded-3xl shadow-xl dark:shadow-2xl p-8 mx-4 border border-white/50 dark:border-white/10 relative z-10 transition-all duration-500">
            <div className="flex flex-col items-center mb-8">
               ...
               <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight text-center">Create Account</h2>
               <p className="text-gray-500 dark:text-gray-400 text-sm mt-2 text-center font-medium">Join FortisWeb today</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
               <div>
                  <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 block pl-1">Full Name</label>
                  <div className="relative group">
                     <i className="fa-regular fa-user absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-red-500 transition-colors"></i>
                     <input
                        type="text"
                        name="name"
            ...
            <div className="mt-8 text-center">
               <p className="text-gray-600 dark:text-gray-500 text-sm font-medium">
                  ...
                  <Link to="/signin" className="text-gray-900 dark:text-white font-black hover:text-red-600 dark:hover:text-red-500 transition-colors ml-1">
                     Sign In
                  </Link>
               </p>
            </div>
